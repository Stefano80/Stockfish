...
namespace {
  ...
  // Pawn penalties
 Score Isolated = S( 4, 14);
 Score Backward = S(10, 21);
 Score Doubled  = S(11, 42);
 int Seed[RANK_NB] = { 0, 16, 29, 13, 63, 115, 216, 340 };

 TUNE(Isolated, Backward, Doubled, Seed, Pawns::init);
